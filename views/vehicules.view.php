...
<aside id="filtresVehiculesContainer">
    <div>
        ...
        <input type="checkbox" name="suvCheck" id="suvCheck" onchange="checkFiltres()">
    </div>
    <div>
        <label for="sportCheck">SPORT</label>
        <input type="checkbox" name="sportCheck" id="sportCheck" onchange="checkFiltres()">
    </div>
    <div>
        <label for="luxeCheck">LUXE</label>
        <input type="checkbox" name="luxeCheck" id="luxeCheck" onchange="checkFiltres()">
    </div>
    <div>
        <label for="coupeCheck">COUPE</label>
        <input type="checkbox" name="coupeCheck" id="coupeCheck" onchange="checkFiltres()">
    </div>
    <div>
        <label for="cabrioletCheck">CABRIOLET</label>
        <input type="checkbox" name="cabrioletCheck" id="cabrioletCheck" onchange="checkFiltres()">
    </div>
    <div>
        <label for="berlineCheck">BERLINE</label>
        <input type="checkbox" name="berlineCheck" id="berlineCheck" onchange="checkFiltres()">
    </div>
    <div>
        <label for="4x4Check">4X4</label>
        <input type="checkbox" name="4x4Check" id="4x4Check" onchange="checkFiltres()">
    </div>
    <div>
        <label for="utilitaireCheck">UTILITAIRE</label>
        <input type="checkbox" name="utilitaireCheck" id="utilitaireCheck" onchange="checkFiltres()">
    </div>
    <div>
        <label for="breakCheck">BREAK</label>
        <input type="checkbox" name="breakCheck" id="breakCheck" onchange="checkFiltres()">
    </div>
    <label for="prixMax">Prix horaire maximum :</label>
    <input type="number" name="prixMax" id="prixMax" onkeyup="checkFiltres()">
    <label for="nbSiegeMin">Nombre de sièges minimum :</label>
    <input type="number" name="nbSiegeMin" id="nbSiegeMin" onkeyup="checkFiltres()">
    <label for="typeBoiteVitesse">Type de boite de vitesse :</label>
    <select name="typeBoiteVitesse" id="typeBoiteVitesse" onchange="checkFiltres()">
        <option value="">Choisir un option :</option>
        <option value="manuelle">Manuelle</option>
        <option value="automatique">Automatique</option>
    </select>
    <label for="clim">Climatisation</label>
    <select name="clim" id="clim" onchange="checkFiltres()">
        <option value="">Choisir un option :</option>
